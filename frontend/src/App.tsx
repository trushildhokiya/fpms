    ...
    <BrowserRouter>
      <Suspense fallback={<Loader />}>
        <Routes>
          ...
          />
          <Route
            path="/admin/display/copyright"
            element={
              <AdminProtectedRoute>
                {" "}
                <AdminCopyrightDisplay />{" "}
              </AdminProtectedRoute>
            }
          />
          <Route
            path="/admin/display/journal"
            element={
              <AdminProtectedRoute>
                {" "}
                <AdminJournalDisplay />{" "}
          ...
          />
          <Route
            path="/admin/display/conference"
            element={
              <AdminProtectedRoute>
                {" "}
                <AdminConferenceDisplay />{" "}
              </AdminProtectedRoute>
            }
          />
          <Route
            path="/admin/display/book"
            element={
              <AdminProtectedRoute>
                {" "}
                <AdminBookDisplay />{" "}
          ...
          />
          <Route
            path="/admin/display/book-chapter"
            element={
              <AdminProtectedRoute>
                {" "}
                <AdminBookChapterDisplay />{" "}
              </AdminProtectedRoute>
            }
          />
          <Route
            path="/admin/display/need-based-projects"
            element={
              <AdminProtectedRoute>
                {" "}
                <AdminNeedBasedProjectDisplay />{" "}
              </AdminProtectedRoute>
            }
          />
          <Route
            path="/admin/display/awards-honors"
            element={
              <AdminProtectedRoute>
                {" "}
                <AdminAwardsHonorsDisplay />{" "}
              </AdminProtectedRoute>
            }
          />
          <Route
            path="/admin/display/projects"
            element={
              <AdminProtectedRoute>
                {" "}
          ...
          />
          <Route
            path="/admin/display/consultancy"
            element={
              <AdminProtectedRoute>
                {" "}
                <AdminConsultancyDisplay />{" "}
              </AdminProtectedRoute>
            }
          />
          <Route
          ...
          />
          <Route
            path="/hod/display/copyright"
            element={
              <HeadProtectedRoute>
                {" "}
                <HeadCopyrightDisplay />{" "}
              </HeadProtectedRoute>
            }
          />
          <Route
            path="/hod/display/journal"
            element={
              <HeadProtectedRoute>
                {" "}
                <HeadJournalDisplay />{" "}
          ...
          />
          <Route
            path="/hod/display/conference"
            element={
              <HeadProtectedRoute>
                {" "}
                <HeadConferenceDisplay />{" "}
              </HeadProtectedRoute>
            }
          />
          <Route
            path="/hod/display/book"
            element={
              <HeadProtectedRoute>
                {" "}
                <HeadBookDisplay />{" "}
          ...
          />
          <Route
            path="/hod/display/book-chapter"
            element={
              <HeadProtectedRoute>
                {" "}
                <HeadBookChapterDisplay />{" "}
              </HeadProtectedRoute>
            }
          />
          <Route
            path="/hod/display/need-based-projects"
            element={
              <HeadProtectedRoute>
                {" "}
                <HeadNeedBasedProjectDisplay />{" "}
              </HeadProtectedRoute>
            }
          />
          <Route
            path="/hod/display/awards-honors"
            element={
              <HeadProtectedRoute>
                {" "}
                <HeadAwardsHonorsDisplay />{" "}
              </HeadProtectedRoute>
            }
          />
          <Route
            path="/hod/display/projects"
            element={
              <HeadProtectedRoute>
                {" "}
                <HeadProjectsDisplay />{" "}
          ...
          />
          <Route
            path="/hod/display/consultancy"
            element={
              <HeadProtectedRoute>
                {" "}
                <HeadConsultancyDisplay />{" "}
              </HeadProtectedRoute>
            }
          />
          <Route
          ...
          />
          <Route
            path="/common/forms/research-profile"
            element={
              <CommonProtectedRoute>
                {" "}
                <ResearchProfileForm />{" "}
          ...
          />
          <Route
            path="/common/forms/qualification"
            element={
              <CommonProtectedRoute>
                {" "}
                <QualificationForm />{" "}
          ...
          />
          <Route
            path="/common/forms/book-chapter"
            element={
              <CommonProtectedRoute>
                {" "}
                <BookChapterForm />{" "}
          ...
          />
          <Route
            path="/common/forms/awards-honors"
            element={
              <CommonProtectedRoute>
                {" "}
                <AwardsAndHonorsForm />{" "}
          ...
          />
          <Route
            path="/common/forms/need-based-projects"
            element={
              <CommonProtectedRoute>
                {" "}
                <NeedProjectsForm />{" "}
          ...
          />
          <Route
            path="/common/forms/sttp-attended"
            element={
              <CommonProtectedRoute>
                {" "}
                <SttpAttended />{" "}
          ...
          />
          <Route
            path="/common/forms/sttp-conducted"
            element={
              <CommonProtectedRoute>
                {" "}
                <SttpConducted />{" "}
          ...
          />
          <Route
            path="/common/forms/sttp-organized"
            element={
              <CommonProtectedRoute>
                {" "}
                <SttpOrganized />{" "}
          ...
          />
          <Route
            path="/common/forms/seminar-conducted"
            element={
              <CommonProtectedRoute>
                {" "}
                <SeminarConducted />{" "}
          ...
          />
          <Route
            path="/common/forms/seminar-attended"
            element={
              <CommonProtectedRoute>
                {" "}
                <SeminarAttended />{" "}
          ...
          />
          <Route
            path="/common/forms/seminar-organized"
            element={
              <CommonProtectedRoute>
                {" "}
                <SeminarOrganized />{" "}
          ...
          {/* AWARDS RECEIVED */}
          <Route
            path="/common/forms/awards-recieved"
            element={
              <CommonProtectedRoute>
                {" "}
                <AwardRecieved />{" "}
          ...
          />
          <Route
            path="/common/edit/awards-recieved/:id"
            element={
              <CommonProtectedRoute>
                {" "}
                <AwardRecievedEditForm />{" "}
              </CommonProtectedRoute>
            }
          />
          <Route
            path="/common/display/awards-recieved"
            element={
              <CommonProtectedRoute>
                {" "}
                <AwardRecievedDisplay />{" "}
              </CommonProtectedRoute>
            }
          />
          ...
          {/* ACTIVITY CONDUCTED */}
          <Route
            path="/common/forms/activity-conducted"
            element={
              <CommonProtectedRoute>
                {" "}
                <ActivityConducted />{" "}
          ...
          />
          <Route
            path="/common/edit/activity-conducted/:id"
            element={
              <CommonProtectedRoute>
                {" "}
                <ActivityConductedEdit />{" "}
              </CommonProtectedRoute>
            }
          />
          <Route
            path="/common/display/activity-conducted"
            element={
              <CommonProtectedRoute>
                {" "}
          ...
          />
          <Route
            path="/common/edit/research-profile"
            element={
              <CommonProtectedRoute>
                {" "}
                <ResearchProfileEditForm />{" "}
              </CommonProtectedRoute>
            }
          />
          <Route
            path="/common/edit/qualification"
            element={
              <CommonProtectedRoute>
                {" "}
          ...
          />
          <Route
            path="/common/edit/conference/:id"
            element={
              <CommonProtectedRoute>
                {" "}
                <ConferenceEditForm />{" "}
          ...
          />
          <Route
            path="/common/edit/book-chapter/:id"
            element={
              <CommonProtectedRoute>
                {" "}
                <BookChapterEditForm />{" "}
          ...
          />
          <Route
            path="/common/edit/need-based-project/:id"
            element={
              <CommonProtectedRoute>
                {" "}
                <NeedBasedProjectEditForm />{" "}
              </CommonProtectedRoute>
            }
          />
          <Route
            path="/common/edit/awards-honors/:id"
            element={
              <CommonProtectedRoute>
                {" "}
                <AwardsHonorsEditForm />{" "}
              </CommonProtectedRoute>
            }
          />
          <Route
            path="/common/edit/consultancy/:id"
            element={
              <CommonProtectedRoute>
                {" "}
                <ConsultancyEditForm />{" "}
          ...
          />
          <Route
            path="/common/display/experience"
            element={
              <CommonProtectedRoute>
                {" "}
                <ExperienceDisplay />{" "}
          ...
          />
          <Route
            path="/common/display/research-profile"
            element={
              <CommonProtectedRoute>
                {" "}
                <ResearchProfileDisplay />{" "}
              </CommonProtectedRoute>
            }
          />
          <Route
            path="/common/display/patent"
            element={
              <CommonProtectedRoute>
                {" "}
                <PatentDisplay />{" "}
          ...
          />
          <Route
            path="/common/display/conference"
            element={
              <CommonProtectedRoute>
                {" "}
                <ConferenceDisplay />{" "}
          ...
          />
          <Route
            path="/common/display/book-chapter"
            element={
              <CommonProtectedRoute>
                {" "}
                <BookChapterDisplay />{" "}
          ...
          />
          <Route
            path="/common/display/need-based-projects"
            element={
              <CommonProtectedRoute>
                {" "}
                <NeedBasedProjectDisplay />{" "}
              </CommonProtectedRoute>
            }
          />
          <Route
            path="/common/display/awards-honors"
            element={
              <CommonProtectedRoute>
                {" "}
                <AwardHonorsDisplay />{" "}
          ...
          />
          <Route
            path="/common/display/consultancy"
            element={
              <CommonProtectedRoute>
                {" "}
                <ConsultancyDisplay />{" "}
          ...
          />
          <Route
            path="/common/display/qualification"
            element={
              <CommonProtectedRoute>
                {" "}
