...
const AdminAwardRecievedDisplay = () => {
    ...
    useEffect(() => {
        axios.get('/admin/data/awards-recieved').then((res) => {
        ...
        <div>
            ...
            <div className="container font-Poppins my-10">
                ...
                <div className="my-10">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className='tracking-wide font-bold text-gray-700 text-3xl py-2'>Institution Awards Received</CardTitle>
                            <CardDescription>Awards Received details of all the faculties is shown below</CardDescription>
                        </CardHeader>
...
export default AdminAwardRecievedDisplay