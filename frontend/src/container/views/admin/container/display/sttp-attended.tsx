...
const AdminSttpAttendedDisplay = () => {
    ...
    useEffect(() => {
        axios.get('/admin/data/sttp-attended')
            .then((res) => {
        ...
        <div>
            ...
            <div className="container font-Poppins my-10">
                ...
                <div className="my-10">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className='tracking-wide font-bold text-gray-700 text-3xl py-2'>Institution STTP/FDP Attended</CardTitle>
                            <CardDescription>STTP/FDP attended details of all the facultiesis shown below</CardDescription>
                        </CardHeader>
...
export default AdminSttpAttendedDisplay