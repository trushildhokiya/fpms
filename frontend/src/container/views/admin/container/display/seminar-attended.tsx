...
const AdminSeminarAttendedDisplay = () => {
    ...
    useEffect(() => {
        axios.get('/admin/data/seminar-attended')
            .then((res) => {
           ...
           <AdminNavbar />
            ...
            <div className="container font-Poppins my-10">
                ...
                <div className="my-10">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className='tracking-wide font-bold text-gray-700 text-3xl py-2'>Institution Seminar Attended</CardTitle>
                            <CardDescription>Seminar attended details of all the faculties is shown below</CardDescription>
                        </CardHeader>
...
export default AdminSeminarAttendedDisplay