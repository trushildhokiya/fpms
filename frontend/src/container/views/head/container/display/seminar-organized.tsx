...
// const HeadSeminarOrganizedDisplay = (props: Props) => {
const HeadSeminarOrganizedDisplay = () => {
    // constants
    ...
    useEffect(() => {
        axios.get('/head/data/seminar-organized')
            .then((res) => {
        ...
        <div>
            ...
            <div className="container font-Poppins my-10">
                ...
                <div className="my-10">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className='tracking-wide font-bold text-gray-700 text-3xl py-2'>Departmental Seminar Organized</CardTitle>
                        ...
                        <CardContent className='font-Poppins'>
                            ...
                            >
                                ...
                                <Column field="remark" style={{ minWidth: '250px' }}  header="Remarks" body={remarksBodyTemplate}></Column>
...
export default HeadSeminarOrganizedDisplay