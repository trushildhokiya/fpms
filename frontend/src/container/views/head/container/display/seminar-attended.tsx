...
const HeadSeminarAttendedDisplay = () => {
    ...
    useEffect(() => {
        axios.get('/head/data/seminar-attended')
            .then((res) => {
        ...
        <div>
            ...
            <div className="container font-Poppins my-10">
                ...
                <div className="my-10">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className='tracking-wide font-bold text-gray-700 text-3xl py-2'>Departmental Seminar Attended</CardTitle>
...
export default HeadSeminarAttendedDisplay