        ...
        <div>
            ...
            <div className="container font-Poppins my-10">
                ...
                <div className="my-10">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className='tracking-wide font-bold text-gray-700 text-3xl py-2'>Department Projects (Major/Minor)</CardTitle>
                        ...
                        <CardContent className='font-Poppins'>
                            ...
                            <DataTable
                                ...
                                exportFilename='department-major-minor-projects' ref={dt} header={header} footer={footerTemplate} value={data} scrollable removableSort sortMode='multiple'
