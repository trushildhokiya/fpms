...
const SttpConductedHeadDisplay = (props: Props) => {
    ...
    useEffect(() => {
        axios.get('/head/data/sttp-conducted')
            .then((res) => {
    ...
    const actionBodyTemplate = (rowData: STTPConducted) => {
        return (
            <>
                <Link to={`/common/edit/sttp-conducted/${rowData._id}`}>
        ...
        <div>
            ...
            <div className="container font-Poppins my-10">
                ...
                <div className="my-10">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className='tracking-wide font-bold text-gray-700 text-3xl py-2'>STTP/FDP Conducted</CardTitle>
                            <CardDescription>STTP/FDP Conducted details of the faculty is shown below</CardDescription>
                        </CardHeader>
...
export default SttpConductedHeadDisplay