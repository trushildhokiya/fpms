...
const HeadSttpConductedDisplay = (props: Props) => {
        ...
        <div>
            ...
            <div className="container font-Poppins my-10">
                ...
                <div className="my-10">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className='tracking-wide font-bold text-gray-700 text-3xl py-2'>Departmental STTP/FDP Conducted</CardTitle>
...
export default HeadSttpConductedDisplay