...
const SttpAttendedHeadDisplay = (props: Props) => {

    // constants
    const user = useSelector((state: any) => state.user)
    const [data, setData] = useState<STTPAttended[]>([]);
    ...
    const convertDates = (sttpAttended: STTPAttended[]) => {
        return sttpAttended.map(sttp => ({
            ...sttp,
    ...
    useEffect(() => {
        axios.get('/head/data/sttp-attended')
            .then((res) => {
    ...
    const actionBodyTemplate = (rowData: STTPAttended) => {
        return (
            <>
                <Link to={`/common/edit/sttp-attended/${rowData._id}`}>
        ...
        <div>
            ...
            <div className="container font-Poppins my-10">
                ...
                <div className="my-10">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className='tracking-wide font-bold text-gray-700 text-3xl py-2'>STTP/FDP Attended</CardTitle>
                            <CardDescription>STTP/FDP attended details of the faculty is shown below</CardDescription>
                        </CardHeader>
...
export default SttpAttendedHeadDisplay