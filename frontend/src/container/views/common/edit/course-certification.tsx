...
const CourseCertificateEdit = (props: Props) => {
  ...
  useEffect(() => {
    axios
        .get(`/common/course-certification/${id}`)
        .then((res) => {
            const data: CourseCertification = res.data
            form.reset({
                ...data,
        ...
        .catch((err) => {
            console.error("Error fetching Course Certification data:", err);
        });
}, []);
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    axios.put("/common/course-certification", values, {
      headers: {
  ...
  .then((res) => {
      if (res.data.message === "success") {
          toast({
              title: "Course Certification updated successfully",
              description:
                  "Your course certification information has been updated successfully",
              action: (
                <ToastAction className='' onClick={() => { navigate('/common/display/course-certification') }} altText="okay">Okay</ToastAction>
              ),
          });
          form.reset();
      }
...
export default CourseCertificateEdit;
