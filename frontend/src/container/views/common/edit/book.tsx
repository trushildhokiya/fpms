...
const formSchema = z.object({
  ...
  proof: z.union([z.any().optional(),pdfFileSchema]),
});
      ...
      .then((res) => {
        if (res.data.message === 'success') {
          ...
          toast({
            ...
            description: "Your book information has been updated successfully",
            action: (
              <ToastAction className='' onClick={() => { navigate('/common/display/book') }} altText="okay">Okay</ToastAction>
            ),
          })
          form.reset()
