...
const formSchema = z.object({
    ...
    applicationNumber: z.string().min(2, {
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className='text-gray-800'>Patent Title</FormLabel>
                                        <FormControl>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className='text-gray-800'>Patent Application Number</FormLabel>
                                        <FormControl>
                            ...
                            <div className="grid md:grid-cols-2 grid-cols-1 gap-6">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className='text-gray-800'>Patent Type</FormLabel>
