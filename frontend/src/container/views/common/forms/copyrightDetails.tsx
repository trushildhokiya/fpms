...
const formSchema = z.object({
    ...
    copyrightApplicationNumber: z.string().min(2, {
...
const CopyrightDetails = (props: Props) => {
                        ...
                        <h2 id='proofUpload' className='my-6 text-2xl font-AzoSans font-bold uppercase text-gray-500'>
                            ...
                            <div>
                                <Alert variant="default" className='bg-amber-500'>
                                    ...
                                    <AlertTitle>NOTE</AlertTitle>
                                    <AlertDescription>
                                        Copyright Certificate must be in a single pdf file of maximum size 5MB.
                                    </AlertDescription>
                                </Alert>
                            </div>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className='text-gray-800'>Copyright Certificate</FormLabel>
                                        <FormControl>
                                            <Input
                                                accept=".pdf"
                                                type="file"
