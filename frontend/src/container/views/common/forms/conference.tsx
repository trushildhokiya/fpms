...
const formSchema = z.object({
    ...
    paperUrl: z.string().min(1).regex(new RegExp(/^(ftp|http|https):\/\/[^ "]+$/), {
        message: "Invalid url"
    }),
                ...
                <div className="p-2 font-Poppins text-xl">
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            ...
                            {/* Conferenec Details */}
                            <h2 id='conferenceDetails' className='my-5 pt-7 text-2xl font-AzoSans font-bold uppercase text-gray-500'>
                                Conference Details
                            </h2>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className=''>
                                            ...
                                            <FormControl>
                                                <Input type='text' placeholder="conference name" autoComplete='off' {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className=''>
                                            ...
                                            <FormControl>
                                                <Input type='text' placeholder="venue" autoComplete='off' {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className=''>
                                            ...
                                            <FormControl>
                                                <Input type='text' placeholder="organizer" autoComplete='off' {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                        ...
                                        <FormItem>
                                            ...
                                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="presented and published">Paper Presented and Published</SelectItem>
                                                </SelectContent>
                                            </Select>
                                            <FormMessage />
                                        </FormItem>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className=''>
                                            ...
                                            <FormControl>
                                                <Input type='number' placeholder="eg: 12-44" autoComplete='off' {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
