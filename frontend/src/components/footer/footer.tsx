    ...
    <div className='mt-10'>
      ...
      <footer className="bg-gray-800 text-white py-8  font-Poppins text-sm leading-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            ...
            <div className="mb-8 md:mb-0 md:flex-1 mx-auto">
              ...
              <ul className='text-center md:text-left'>
                ...
                <li><a href="https://forms.gle/bR5o2MP9wiSgN6WZ7" target='_blank' referrerPolicy='no-referrer' className="hover:underline">FEEDBACK</a></li>
                <li><a  href="https://mail.google.com/mail/?view=cm&fs=1&to=fpms.tech@somaiya.edu" target='_blank' className="hover:underline">CONTACT</a></li>
              </ul>
            </div>
            <div className="mb-8 md:mb-0 md:flex-1 mx-auto ">
        ...
        <div className="text-center mt-8">
          ...
          <p>Department of Computer Engineering- KJSIT </p>
          <p>DESIGN BY FPMS</p>
        </div>
      </footer>
    </div>
